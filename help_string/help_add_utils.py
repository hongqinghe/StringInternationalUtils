...
from help_string import help_xml_covert_excel,help_excel_convet_xml_utils

def toConvert():
    help_xml_covert_excel.xmlConversionExcel()
    help_excel_convet_xml_utils.toConvert()
